export default {
  ...
  finance: {
    title: 'Finance',
    subtitle: 'Wallet, transactions, and cost centers',
    ...
    budgetSaveFailed: 'Failed to save budgets',
    ...
    adjustmentFailed: 'Wallet adjustment failed',
    manageMembers: 'Manage cost center members',
    memberCanPrint: 'Member can print',
    selectCostCenter: 'Please select a cost center',
    ...
    noEligibleUsers: 'No eligible users available',
    ...
    owner: 'Owner',
    userWithId: 'User #{{id}}',
    adminActions: 'Finance administration',
    adminActionsHint: 'Advanced finance actions are available in dialogs.',
    editBudgets: 'Edit budgets',
    budgetsHint: 'Set total and monthly budget values per cost center.',
    settingsHint: 'Administrative finance configuration can also be managed in Settings.',
    ...
    paginationHint: 'Use pagination below to browse all transactions.',
